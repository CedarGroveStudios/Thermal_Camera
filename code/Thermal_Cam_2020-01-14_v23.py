# Thermal_Cam_2020-01-14_v23.py
# (c) 2020 Cedar Grove Studios

print("Thermal_Cam_2020-01-14_v23.py")
...
# Look for the PyGamer's joystick
...
# Build the foundational thermal image element definitions
# image_group[1:64]; image_group[#]=(row * 8) + column
for row in range(0, 8):
    for col in range(0, 8):
...
# Convert default alarm and min/max range values from config file to Celsius
